...
""" Regression Model Evaluation Setup (Pool 5) """
...
# Create training/validation and test splits for all regression targets in Pool 5
X_train_val_5_mint_main, X_test_5_mint_main, y_train_val_5_mint_main, y_test_5_mint_main = process_dataframe_regr(usdc_weth_5, "next_mint_time_main")
X_train_val_5_burn_main, X_test_5_burn_main, y_train_val_5_burn_main, y_test_5_burn_main = process_dataframe_regr(usdc_weth_5, "next_burn_time_main")
X_train_val_5_mint_other, X_test_5_mint_other, y_train_val_5_mint_other, y_test_5_mint_other = process_dataframe_regr(usdc_weth_5, "next_mint_time_other")
X_train_val_5_burn_other, X_test_5_burn_other, y_train_val_5_burn_other, y_test_5_burn_other = process_dataframe_regr(usdc_weth_5, "next_burn_time_other")

# Load in the best estimator for each regression target in Pool 5 
model_5_mint_main = joblib.load("krr_5_mint_main_final.joblib")
model_5_burn_main = joblib.load("knn_5_burn_main_final.joblib")
model_5_mint_other = joblib.load("knn_5_mint_other_final.joblib")
model_5_burn_other = joblib.load("xgb_5_burn_other_final.joblib")

# Make predictions on the test split of each target with the respective best estimator
y_pred_5_mint_main = model_5_mint_main.predict(X_test_5_mint_main)
y_pred_5_burn_main = model_5_burn_main.predict(X_test_5_burn_main)
y_pred_5_mint_other = model_5_mint_other.predict(X_test_5_mint_other)
y_pred_5_burn_other = model_5_burn_other.predict(X_test_5_burn_other)

# Make predictions on the training/validation split of each target with the respective best estimator
y_train_pred_5_mint_main = model_5_mint_main.predict(X_train_val_5_mint_main)
y_train_pred_5_burn_main = model_5_burn_main.predict(X_train_val_5_burn_main)
y_train_pred_5_mint_other = model_5_mint_other.predict(X_train_val_5_mint_other)
y_train_pred_5_burn_other = model_5_burn_other.predict(X_train_val_5_burn_other)

# Make predictions on the test split with the baseline persistence model for each target
dummy_y_pred_5_mint_main = np.log1p(X_test_5_mint_main['b1_mint_main'])
dummy_y_pred_5_burn_main = np.log1p(X_test_5_burn_main['b1_burn_main'])
dummy_y_pred_5_mint_other = np.log1p(X_test_5_mint_other['b1_mint_other'])
dummy_y_pred_5_burn_other = np.log1p(X_test_5_burn_other['b1_burn_other'])

# Plot style
sns.set_style("darkgrid")


""" Regression Model Evaluation and Plots (Pool 5) """

# Table 7.1 (Persistence Accuracy)
print(mean_squared_error(y_test_5_mint_main, dummy_y_pred_5_mint_main))
print(mean_squared_error(y_test_5_burn_main, dummy_y_pred_5_burn_main))
print(mean_squared_error(y_test_5_mint_other, dummy_y_pred_5_mint_other))
print(mean_squared_error(y_test_5_burn_other, dummy_y_pred_5_burn_other))

# Table 7.1 (Best Estimator Accuracy) 
print(mean_squared_error(y_test_5_mint_main, y_pred_5_mint_main))
print(mean_squared_error(y_test_5_burn_main, y_pred_5_burn_main))
print(mean_squared_error(y_test_5_mint_other, y_pred_5_mint_other))
print(mean_squared_error(y_test_5_burn_other, y_pred_5_burn_other))
...
# Figure 7.1
plot_marginal_dists(y_train_val_5_mint_main, y_train_pred_5_mint_main, y_test_5_mint_main, y_pred_5_mint_main,
                   title="Marginal Distributions of next_mint_time_main (Main Pool: 5)")

# Figure 7.3
plot_marginal_dists(y_train_val_5_burn_main, y_train_pred_5_burn_main, y_test_5_burn_main, y_pred_5_burn_main,
                   title="Marginal Distributions of next_burn_time_main (Main Pool: 5)")

# Figure 7.5
plot_marginal_dists(y_train_val_5_mint_other, y_train_pred_5_mint_other, y_test_5_mint_other, y_pred_5_mint_other,
                   title="Marginal Distributions of next_mint_time_other (Main Pool: 5)")

# Figure 7.7
plot_marginal_dists(y_train_val_5_burn_other, y_train_pred_5_burn_other, y_test_5_burn_other, y_pred_5_burn_other,
                   title="Marginal Distributions of next_burn_time_other (Main Pool: 5)")
...
# Table 7.2 (first row)
calculate_kl_divergence(y_train_val_5_mint_main, y_train_pred_5_mint_main, y_test_5_mint_main, y_pred_5_mint_main)

# Table 7.2 (second row)
calculate_kl_divergence(y_train_val_5_burn_main, y_train_pred_5_burn_main, y_test_5_burn_main, y_pred_5_burn_main)

# Table 7.2 (third row)
calculate_kl_divergence(y_train_val_5_mint_other, y_train_pred_5_mint_other, y_test_5_mint_other, y_pred_5_mint_other)

# Table 7.2 (fourth row)
calculate_kl_divergence(y_train_val_5_burn_other, y_train_pred_5_burn_other, y_test_5_burn_other, y_pred_5_burn_other)
...
# Figure 7.2
plot_prediction_error(y_test_5_mint_main, y_pred_5_mint_main, 
                     title="Prediction Error Analysis for next_mint_time_main (Main Pool: 5)")

# Figure 7.4 
plot_prediction_error(y_test_5_burn_main, y_pred_5_burn_main, 
                     title="Prediction Error Analysis for next_burn_time_main (Main Pool: 5)")

# Figure 7.6
plot_prediction_error(y_test_5_mint_other, y_pred_5_mint_other, 
                     title="Prediction Error Analysis for next_mint_time_other (Main Pool: 5)")

# Figure 7.8
plot_prediction_error(y_test_5_burn_other, y_pred_5_burn_other, 
                     title="Prediction Error Analysis for next_burn_time_other (Main Pool: 5)")
