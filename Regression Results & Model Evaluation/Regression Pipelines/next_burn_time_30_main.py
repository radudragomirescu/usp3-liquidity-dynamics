...
""" Regression Pipeline for next_burn_time_main in Pool 30"""
...
# Create training/validation and test splits for targeting next_burn_time_main in Pool 30
X_train_val_30_burn_main, X_test_30_burn_main, y_train_val_30_burn_main, y_test_30_burn_main = \
        process_dataframe_regr(usdc_weth_30, "next_burn_time_main")

# Apply fit_model_regr for all methods and create a DataFrame with cross-validation results
trained_models_30_burn_main = individual_training_regr(X_train_val_30_burn_main, y_train_val_30_burn_main)

# Inspect cross-validation results
trained_models_30_burn_main

# Make predictions on the test split with each best estimator
test_pred_30_burn_main = prediction_results_regr(X_test_30_burn_main, y_test_30_burn_main, 
                                                 X_train_val_30_burn_main, y_train_val_30_burn_main, 
                                                 trained_models_30_burn_main)

# Table C.6
test_pred_30_burn_main

# Save the best estimator (RandomForestRegressor)
joblib.dump(trained_models_30_burn_main.loc[8, 'Best Estimator'], "rf_30_burn_main_final.joblib")