...
""" Regression Pipeline for next_mint_time_main in Pool 30"""
...
# Create training/validation and test splits for targeting next_mint_time_main in Pool 30
X_train_val_30_mint_main, X_test_30_mint_main, y_train_val_30_mint_main, y_test_30_mint_main = \
        process_dataframe_regr(usdc_weth_30, "next_mint_time_main")

# Apply fit_model_regr for all methods and create a DataFrame with cross-validation results
trained_models_30_mint_main = individual_training_regr(X_train_val_30_mint_main, y_train_val_30_mint_main)

# Inspect cross-validation results
trained_models_30_mint_main

# Make predictions on the test split with each best estimator
test_pred_30_mint_main = prediction_results_regr(X_test_30_mint_main, y_test_30_mint_main, 
                                                 X_train_val_30_mint_main, y_train_val_30_mint_main, 
                                                 trained_models_30_mint_main)

# Table C.5
test_pred_30_mint_main

# Save the best estimator (XGBRegressor)
joblib.dump(trained_models_30_mint_main.loc[10, 'Best Estimator'], "xgb_30_mint_main_final.joblib")
