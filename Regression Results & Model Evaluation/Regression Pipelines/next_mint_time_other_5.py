...
""" Regression Pipeline for next_mint_time_other in Pool 5"""
...
# Create training/validation and test splits for targeting next_mint_time_other in Pool 5
X_train_val_5_mint_other, X_test_5_mint_other, y_train_val_5_mint_other, y_test_5_mint_other = \
        process_dataframe_regr(usdc_weth_5, "next_mint_time_other")

# Apply fit_model_regr for all methods and create a DataFrame with cross-validation results
trained_models_5_mint_other = individual_training_regr(X_train_val_5_mint_other, y_train_val_5_mint_other)

# Inspect cross-validation results
trained_models_5_mint_other

# Make predictions on the test split with each best estimator
test_pred_5_mint_other = prediction_results_regr(X_test_5_mint_other, y_test_5_mint_other, 
                                                 X_train_val_5_mint_other, y_train_val_5_mint_other, 
                                                 trained_models_5_mint_other)

# Table C.3
test_pred_5_mint_other

# Save the best estimator (KNeighborsRegressor)
joblib.dump(trained_models_5_mint_other.loc[5, 'Best Estimator'], "knn_5_mint_other_final.joblib")
