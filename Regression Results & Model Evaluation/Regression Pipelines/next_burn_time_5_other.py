...
""" Regression Pipeline for next_burn_time_other in Pool 5"""
...
# Create training/validation and test splits for targeting next_burn_time_other in Pool 5
X_train_val_5_burn_other, X_test_5_burn_other, y_train_val_5_burn_other, y_test_5_burn_other = \
        process_dataframe_regr(usdc_weth_5, "next_burn_time_other")

# Apply fit_model_regr for all methods and create a DataFrame with cross-validation results
trained_models_5_burn_other = individual_training_regr(X_train_val_5_burn_other, y_train_val_5_burn_other)

# Inspect cross-validation results
trained_models_5_burn_other

# Make predictions on the test split with each best estimator
test_pred_5_burn_other = prediction_results_regr(X_test_5_burn_other, y_test_5_burn_other, 
                                                 X_train_val_5_burn_other, y_train_val_5_burn_other, 
                                                 trained_models_5_burn_other)

# Table C.4
test_pred_5_burn_other

# Save the best estimator (XGBRegressor)
joblib.dump(trained_models_5_burn_other.loc[10, 'Best Estimator'], "xgb_5_burn_other_final.joblib")