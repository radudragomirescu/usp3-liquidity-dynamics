...
""" Regression Pipeline for next_mint_time_main in Pool 5"""
...
# Create training/validation and test splits for targeting next_mint_time_main in Pool 5
X_train_val_5_mint_main, X_test_5_mint_main, y_train_val_5_mint_main, y_test_5_mint_main = \
        process_dataframe_regr(usdc_weth_5, "next_mint_time_main")

# Apply fit_model_regr for all methods and create a DataFrame with cross-validation results
trained_models_5_mint_main = individual_training_regr(X_train_val_5_mint_main, y_train_val_5_mint_main)

# Inspect cross-validation results
trained_models_5_mint_main

# Make predictions on the test split with each best estimator
test_pred_5_mint_main = prediction_results_regr(X_test_5_mint_main, y_test_5_mint_main, 
                                                X_train_val_5_mint_main, y_train_val_5_mint_main, 
                                                trained_models_5_mint_main)

# Table C.1
test_pred_5_mint_main

# Save the best estimator (KernelRidge)
joblib.dump(trained_models_5_mint_main.loc[3, 'Best Estimator'], "krr_5_mint_main_final.joblib")