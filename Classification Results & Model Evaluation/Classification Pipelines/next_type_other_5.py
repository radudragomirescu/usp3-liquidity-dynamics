...
""" Classification Pipeline for next_type_other in Pool 5 """
...
trained_models_5_other

# Make predictions on the test split with each best estimator 
test_pred_5_other = prediction_results_clf(X_test_5_other, y_test_5_other, 
                                           X_train_val_5_other, y_train_val_5_other, 
                                           trained_models_5_other)

# Table B.2
test_pred_5_other

# Save the best estimator (DecisionTreeClassifier)
joblib.dump(trained_models_5_other.loc[5, 'Best Estimator'], "decision_5_other_final.joblib")
