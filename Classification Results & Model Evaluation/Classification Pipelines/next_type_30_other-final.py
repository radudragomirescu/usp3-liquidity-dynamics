...
""" Classification Pipeline for next_type_other in Pool 30 """
...
# Create training/validation and test splits for targeting next_type_other in Pool 30
...
trained_models_30_other = individual_training_clf(X_train_val_30_other, y_train_val_30_other)

# Inspect cross-validation results
trained_models_30_other

# Make predictions on the test split with each best estimator
test_pred_30_other = prediction_results_clf(X_test_30_other, y_test_30_other, 
                                            X_train_val_30_other, y_train_val_30_other, 
                                            trained_models_30_other)

# Table B.4
test_pred_30_other

# Save the best estimator (KneighborsClassifier)
joblib.dump(trained_models_30_other.loc[3, 'Best Estimator'], "knn_30_other_final.joblib")