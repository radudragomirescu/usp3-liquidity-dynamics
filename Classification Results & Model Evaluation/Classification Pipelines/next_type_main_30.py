...
""" Classification Pipeline for next_type_main in Pool 30 """
...
# Create training/validation and test splits for targeting next_type_main in Pool 30
...
trained_models_30_main = individual_training_clf(X_train_val_30_main, y_train_val_30_main)

# Inspect cross-validation results
trained_models_30_main

# Make predictions on the test split with each best estimator
test_pred_30_main = prediction_results_clf(X_test_30_main, y_test_30_main, 
                                           X_train_val_30_main, y_train_val_30_main, 
                                           trained_models_30_main)

# Table B.3
test_pred_30_main

# Save the best estimator (LGBMClassifier)
joblib.dump(trained_models_30_main.loc[9, 'Best Estimator'], "lgbm_30_main_final.joblib")
